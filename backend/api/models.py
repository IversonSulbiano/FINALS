...
class Item(models.Model):
    first_name = models.CharField(max_length=100, default='Iverson')
    middle_name = models.CharField(max_length=100, default='Delfin')
    last_name = models.CharField(max_length=100, default='Sulbiano')
